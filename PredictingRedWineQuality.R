...
#' 
## ---- Quality Frequency, include= TRUE--------------------------------------------------
...
#' 
## ---- CorrelationMatrix, include=TRUE---------------------------------------------------
